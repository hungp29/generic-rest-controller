...
import static org.example.generic.controller.support.generic.annotation.APIGeneric.APIGenericMethod.DELETE;

/**
 * Annotation for mapping Delete.
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@APIGeneric(method = RequestMethod.DELETE, genericMethod = DELETE)
